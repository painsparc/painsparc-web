    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black pt-32 px-4 md:px-8 pb-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          {/* Future Entries (Faded out to show it's an ongoing archive) */}
          <div className="opacity-40 pointer-events-none select-none border border-zinc-800/50 rounded-2xl p-8 md:p-12">
             <span className="inline-block px-3 py-1 bg-zinc-800 text-zinc-500 text-[10px] font-bold uppercase tracking-widest rounded-full mb-6">
                  Upcoming
             </span>
             <h2 className="text-2xl font-bold text-zinc-600 tracking-tight">
                  HPDI Experimental Protocols
             </h2>
          </div>
